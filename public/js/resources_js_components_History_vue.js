...
/* harmony import */ var vue2_datepicker_scss_index_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! vue2-datepicker/scss/index.scss */ "./node_modules/vue2-datepicker/scss/index.scss");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getTimeCreated: function getTimeCreated(date) {
    ...
    getReservationDate: function getReservationDate(date) {
      var days = ["Воскресенье", "Понедельник", "Вторник", "Среда", "Четверг", "Пятница", "Суббота"];
      var Y = date.getFullYear();
      var M = this.addLeadingZero(date.getMonth() + 1);
      var D = this.addLeadingZero(date.getDate());
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                _this2.logs = logs.reverse();
                _this2.loading = false;

              case 8:
                if (!(_this2.place === "place_2")) {
                  _context2.next = 16;
                  break;
                }
              ...
              case 12:
                ...
                _this2.logs = _logs.reverse();
                _this2.loading = false;

              case 16:
                if (!(_this2.place === "place_3")) {
                  _context2.next = 25;
                  break;
                }
            ...
            _vm._l(_vm.logs, function (log) {
              return _c(
                ...
                [
                  _vm._v(
                    "\n                " +
                      _vm._s(_vm.getTimeCreated(new Date(log.created_at))) +
                      ".\n                " +
                      _vm._s(log.type) +
                      ".\n                " +
                      _vm._s(log.text) +
                  ...
                  _c("div", { staticClass: "dropdown ms-auto" }, [
                    ...
                    _vm._v(" "),
                    _c("div", { staticClass: "dropdown-menu p-0" }, [
                        ...
                        _c("div", { staticClass: "modal-body" }, [
                          _c("div", { staticClass: "row" }, [
                            _c("div", { staticClass: "mb-3 col-6" }, [
                              ...
                              _c("input", {
                                ...
                                domProps: { value: log.name },
                                on: {
                                  input: function ($event) {
                                    if ($event.target.composing) {
                                      return
                                    }
                                    _vm.$set(log, "name", $event.target.value)
                                  },
                                },
                              }),
                            ]),
                            ...
                            _c("div", { staticClass: "mb-3 col-6" }, [
                              ...
                              _c("input", {
                                ...
                                domProps: { value: log.phone },
                                on: {
                                  input: function ($event) {
                                    if ($event.target.composing) {
                                      return
                                    }
                                    _vm.$set(log, "phone", $event.target.value)
                                  },
                                },
                              }),
                            ]),
                          ...
                          _c("div", { staticClass: "form-check mb-3" }, [
                            ...
                            _c("input", {
                              ...
                              domProps: {
                                checked: Array.isArray(log.conflict)
                                  ? _vm._i(log.conflict, "") > -1
                                  : log.conflict,
                              },
                              on: {
                            ...
                            _c("div", { staticClass: "mb-3 col-6" }, [
                              ...
                              _c(
                                "select",
                                {
                                  directives: [
                                    {
                                      name: "model",
                                      rawName: "v-model",
                                      value: log.visit_type,
                                      expression: "log.visit_type",
                                    },
                                  ],
                                  staticClass: "form-control",
                                  attrs: {
                                  ...
                                  on: {
                                    change: [
                                      ...
                                      function ($event) {
                                        log.visit_type = $event.target.value
                                      },
                                    ],
                                  },
                                },
                                [
                                  ...
                                  _c(
                                    "option",
                                    { attrs: { value: "Романтический ужин" } },
                                    [
                                      _vm._v(
                                        "\n                                                Романтический ужин\n                                            "
                                      ),
                            ...
                            _c("div", { staticClass: "mb-3 col-6" }, [
                              ...
                              _c(
                                "select",
                                {
                                  ...
                                  attrs: { id: "guest_amount", disabled: "" },
                                  on: {
                                    change: [
                                      function ($event) {
                                        var $$selectedVal =
                          ...
                          _c("div", { staticClass: "mb-3" }, [
                            ...
                            _c("input", {
                              ...
                              domProps: { value: log.note },
                              on: {
                                input: function ($event) {
                                  if ($event.target.composing) {
                                    return
                                  }
                                  _vm.$set(log, "note", $event.target.value)
                                },
                              },
                            }),
                          ]),
                                ...
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: log.prepayment,
                                    expression: "log.prepayment",
                                  },
                                ],
                                staticClass: "form-control",
                                attrs: {
                          ...
                          _c("div", { staticClass: "mb-3 row" }, [
                            _c("div", { staticClass: "col-6" }, [
                              ...
                              _c("input", {
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: log.responsible_name,
                                    expression: "log.responsible_name",
                                  },
                                ],
                                ...
                                domProps: { value: log.responsible_name },
                                on: {
                                  input: function ($event) {
                                    if ($event.target.composing) {
                                      return
                            ...
                            _c("div", { staticClass: "col-6" }, [
                              ...
                              _c("input", {
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: log.responsible_email,
                                    expression: "log.responsible_email",
                                  },
                                ],
                                staticClass: "form-control col-6",
                                attrs: {
                                ...
                                domProps: { value: log.responsible_email },
                                on: {
                                  input: function ($event) {
                                    if ($event.target.composing) {
                                      return
...
var staticRenderFns = [
  ...
  function () {
    ...
    return _c("div", { staticClass: "modal-header" }, [
      _c(
        "h5",
        { staticClass: "modal-title", attrs: { id: "updateGuestModal" } },
        [
          _vm._v(
