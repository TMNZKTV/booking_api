...
class CreateFailedReservationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('failed_reservations', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
            $table->string('name');
    ...
    {
        Schema::dropIfExists('failed_reservations');
    }
}
